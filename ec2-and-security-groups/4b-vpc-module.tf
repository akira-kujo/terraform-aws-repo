module "vpc" {
    ...
    # contains the logic to invoke the VPC ID and assign it via AWS to the created resources
    name = "${local.name}-${var.vpc_name}" //SAP-dev-myvpc
    ...
    tags = local.common_tags // defined in locals/common_tags (owners & environment)
